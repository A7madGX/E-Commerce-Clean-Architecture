...
import 'package:flutter_mapp_clean_architecture/features/shop/presentation/pages/view_all_products_page.dart';
    ...
    return SliverPadding(
      ...
      sliver: SliverMainAxisGroup(
        slivers: [
                  ...
                  child: GHeaderTitle(
                    ...
                    onClick: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => const ViewAllProductsPage()),
                      );
                    },
                  ),
                ),
          ...
          SliverToBoxAdapter(child: SizedBox(height: GSizes.spaceBtwSections)),
          SliverMainAxisGroup(
            slivers: [
              const SliverToBoxAdapter(
                child: SliderBottomSection(),
